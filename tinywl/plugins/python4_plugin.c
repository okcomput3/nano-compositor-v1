...
bool launch_python_script(struct plugin_state *state, const char *script_path) {
    ...
    if (strstr(script_path, "hosted_mouse_plugin4.py") == NULL) {
        loggy_opengl_desktop("[C LOADER] WARNING: Got unexpected script path, using plugins/hosted_mouse_plugin4.py\n");
        script_path = "plugins/hosted_mouse_plugin4.py";
    }
